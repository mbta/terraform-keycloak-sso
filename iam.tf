...
resource "aws_iam_role" "keycloak-ecs-execution-role" {
...
resource "aws_iam_role" "keycloak-ecs-task-role" {
...
resource "aws_iam_role_policy_attachment" "ecs-execution-policy" {
  role       = aws_iam_role.keycloak-ecs-execution-role.name
...
resource "aws_iam_role_policy" "keycloak_to_app_user_updates_publish" {
  ...
  role   = aws_iam_role.keycloak-ecs-task-role.name
